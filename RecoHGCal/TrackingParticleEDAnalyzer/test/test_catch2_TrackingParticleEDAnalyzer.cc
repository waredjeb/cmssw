...
static constexpr auto s_tag = "[TrackingParticleEDAnalyzer]";

TEST_CASE("Standard checks of TrackingParticleEDAnalyzer", s_tag) {
  const std::string baseConfig{
      R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("TrackingParticleEDAnalyzer"
