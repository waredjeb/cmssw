...
//   */
//  class g : public stream::EDProducer<> {
//  public:
//    g(const edm::ParameterSet &params);
//
...
//  };
//
//  g::TracksterLinkingByGNNProducer(edm::ParameterSet const &params)
//      : EDProducer<>(params),
...
//   */
//  void g::produce(device::Event &event, const device::EventSetup &event_setup) {
...
//   */
//  void g::fillDescriptions(edm::ConfigurationDescriptions &descriptions) {
