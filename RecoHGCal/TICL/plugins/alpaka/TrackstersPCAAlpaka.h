...
namespace ticlAlpaka {
   ...
   */
  void assignPCAtoTracksters(std::vector<ticl::Trackster> &tracksters,
                             ...
                             int minLayer = 10,
                             int maxLayer = 10);
  std::pair<float, float> computeLocalTracksterTime(const ticl::Trackster &trackster,
                                                    const std::vector<reco::CaloCluster> &layerClusters,
                                                    const edm::ValueMap<std::pair<float, float>> &layerClustersTime,
                                                    const Eigen::Vector3f &barycenter,
                                                    size_t N);
  std::pair<float, float> computeTracksterTime(const ticl::Trackster &trackster,
                                               const edm::ValueMap<std::pair<float, float>> &layerClustersTime,
                                               size_t N);
  ...
  inline std::vector<std::vector<unsigned>> sortByLayer(const ticl::Trackster &ts,
                                                        const std::vector<reco::CaloCluster> &layerClusters,
