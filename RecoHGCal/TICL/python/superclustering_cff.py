...
from RecoHGCal.TICL.tracksterFilter_cff import filteredTrackstersEM, tracksterFilterEMTask
...
# DNN
_dnn_task = cms.Task(tracksterFilterEMTask, ticlTracksterLinksSuperclusteringDNN)
...
# Mustache-TICL
_mustache_ticl_task = cms.Task(tracksterFilterEMTask, ticlTracksterLinksSuperclusteringMustache)
