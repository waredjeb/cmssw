...
from RecoHGCal.TICL.ticlDumperSimple_cfi import ticlDumperSimple as ticlDumperSimple_
...
ticlDumperSimple = ticlDumperSimple_.clone(
...
ticl_v5.toModify(ticlDumperSimple, ticlcandidates = cms.InputTag("ticlCandidate"), recoSuperClusters_sourceTracksterCollection=cms.InputTag("ticlCandidate"))
ticl_v5.toModify(ticlDumperSimple, saveSuperclustering = cms.bool(True))



(ticl_v5 & ticl_superclustering_mustache_pf).toModify(ticlDumperSimple, saveSuperclustering=False, recoSuperClusters_sourceTracksterCollection=cms.InputTag("ticlCandidate"))
