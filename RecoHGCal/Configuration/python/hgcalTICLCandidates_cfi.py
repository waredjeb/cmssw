...
# Offline TICLCandidates table - adapted from HLT version
ticlCandidateTable = cms.EDProducer(
    "TICLCandidateTableProducer",
    skipNonExistingSrc=cms.bool(True),
    src=cms.InputTag("ticlTrackstersMerge"),  # Offline collection
    cut=cms.string(""),
...
ticlSimCandidateTable = cms.EDProducer(
    "TICLCandidateTableProducer",
    skipNonExistingSrc=cms.bool(True),
    src=cms.InputTag("ticlSimTracksters"),  # Offline SimTracksters
    cut=cms.string(""),
...
# Modify for TICLv5 to use ticlCandidate instead of ticlTrackstersMerge
ticl_v5.toModify(ticlCandidateTable, src=cms.InputTag('ticlCandidate'))
ticl_v5.toModify(ticlCandidateExtraTable, src=cms.InputTag('ticlCandidate'))
