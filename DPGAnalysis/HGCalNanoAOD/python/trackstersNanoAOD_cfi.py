...
for iterLabel in ticlIterLabels:
    ...
    for iterLabelSim in SimTrackstersLabels:
        ...
        TrackstersAssociationOneToManyTable.append(
            trackstersAssociationOneToManyTable)
    TrackstersTable.append(tracksterTable)
SimTrackstersTables = []
for iterLabel in SimTrackstersLabels:
        label, objName = iterLabel.split(f"{iterLabel}")
        SimTracksterTable = cms.EDProducer(
            "TracksterCollectionTableProducer",
            skipNonExistingSrc=cms.bool(True),
            src=cms.InputTag(f"SimTracksters", objName),
            cut=cms.string(""),
        ...
        TiclSimTrackstersExtraTable = cms.EDProducer("SimTracksterTableProducer",
        ...
        SimTrackstersTables.extend([SimTracksterTable, TiclSimTrackstersExtraTable])
