...
hltTiclCandidate = cms.EDProducer("TICLCandidateProducer",
    ...
    general_tracksterlinks_collections = cms.VInputTag("hltTiclTracksterCleaning"),
    general_tracksters_collections = cms.VInputTag("hltTiclTracksterCleaning"),
...
ticlv5_TrackLinkingGNN.toModify(hltTiclCandidate,
    interpretationDescPSet = cms.PSet(
        onnxTrkLinkingModelFirstDisk = cms.string('RecoHGCal/TICL/data/ticlv5/onnx_models/TrackLinking_GNN/FirstDiskPropGNN_v0.onnx'),
        onnxTrkLinkingModelInterfaceDisk = cms.string('RecoHGCal/TICL/data/ticlv5/onnx_models/TrackLinking_GNN/InterfaceDiskPropGNN_v0.onnx'),
