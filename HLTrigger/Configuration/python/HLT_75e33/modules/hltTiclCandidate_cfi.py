...
hltTiclCandidate = cms.EDProducer("TICLCandidateProducer",
    ...
    egamma_tracksterlinks_collections = cms.VInputTag("hltTiclTracksterLinksBySkeletonsUnseeded"),
    egamma_tracksters_collections = cms.VInputTag("hltTiclTracksterLinksBySkeletonsUnseeded"),
    general_tracksterlinks_collections = cms.VInputTag("hltTiclTracksterLinksBySkeletonsUnseeded"),
    general_tracksters_collections = cms.VInputTag("hltTiclTracksterLinksBySkeletonsUnseeded"),
