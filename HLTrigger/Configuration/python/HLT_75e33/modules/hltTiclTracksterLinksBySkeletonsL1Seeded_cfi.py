...
from ..psets.hltTiclTracksterLinksPSet_cfi import hltTiclTracksterLinksBySkeletonsPSet 

hltTiclTracksterLinksBySkeletonsL1Seeded = cms.EDProducer("TracksterLinksProducer",
    ...
    linkingAlgoBySkeletons  =  hltTiclTracksterLinksBySkeletonsPSet,
