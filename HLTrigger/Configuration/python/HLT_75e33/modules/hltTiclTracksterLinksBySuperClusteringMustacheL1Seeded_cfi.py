...
hltTiclTracksterLinksBySuperClusteringMustache1Seeded = cms.EDProducer("TracksterLinksProducer",
    ...
    tracksters_collections = cms.VInputTag("hltTiclTrackstersCLUE3DHighL1Seeded")
)
